...
WHERE
    ...
    AND (CAST(:especialidad_nombre AS INTEGER) IS NULL OR e.especialidad_id = CAST(:especialidad_nombre AS INTEGER))
    AND (CAST(:clinica_nombre AS INTEGER) IS NULL OR c.clinica_id = CAST(:clinica_nombre AS INTEGER))
